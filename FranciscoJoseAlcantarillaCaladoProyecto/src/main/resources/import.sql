...
insert into producto (id, nombre, descripcion, precio, imagen, categoria_id) values (3, 'Equipación de entrenamiento de Isco','Equipación con la que entrena isco', 60.0, 'https://shop.realbetisbalompie.es/cdn/shop/files/222512-6143_2_1_c177a66b-1451-4997-bf5e-021a9c4cac9f.jpg?crop=center&v=1718619950&width=960', 2);
...
insert into producto (id, nombre, descripcion, precio, imagen, categoria_id) values (18, 'Llavero de Joaquin','Llavero exlusivo del partido de despedida en homenaje a joaquin', 75.0, 'https://shop.realbetisbalompie.es/cdn/shop/files/llavero_negro_joaking_3cee3095-046d-441c-8802-f073badb754e.jpg?crop=center&v=1718619947&width=960', 3);
...
insert into producto (id, nombre, descripcion, precio, imagen, categoria_id) values (26, 'Albornoz del betis','Secate sintintiendo tus colores y sintiente un verdadero jugador', 25.0, 'https://shop.realbetisbalompie.es/cdn/shop/files/albornoz_betis.2.jpg?crop=center&v=1718620031&width=960', 3);
